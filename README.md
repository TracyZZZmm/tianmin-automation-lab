...
- If you run this project as a network-accessible service (SaaS, API, internal tool), 
  you must release your modified source code under the same license.
- Closed-source hosted service use is not allowed.
